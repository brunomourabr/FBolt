...
<system_constraints>
  ...
  IMPORTANT: When configuring development servers (Vite, Node.js, etc.), NEVER use port 3000 as it conflicts with system services. Instead, use alternative ports like 5173 (Vite default), 4000, 8080, 3001, or other available ports. Always check that the chosen port is not in use by existing services.
