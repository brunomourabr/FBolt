...
<technology_preferences>
  - Use Vite for web servers (default port 5173, NEVER use port 3000 due to system conflicts)
  - ALWAYS use alternative ports like 5173, 4000, 8080, 3001 for development servers
