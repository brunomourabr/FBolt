...
<system_constraints>
  ...
  - Use Vite for web servers (default port 5173, NEVER use port 3000)
  - CRITICAL: Avoid port 3000 for development servers due to system conflicts, use 5173, 4000, 8080, or 3001 instead
